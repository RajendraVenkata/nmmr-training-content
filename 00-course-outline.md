...
Every module includes a **Docker-based hands-on lab** accessible via the browser terminal (term.js):

```
┌─────────────────────────────────────────────┐
│  Browser (Training Website)                 │
│  ┌──────────────────┐ ┌──────────────────┐  │
│  │  Training Content │ │  term.js Terminal │  │
│  │  (Left Panel)     │ │  (Right Panel)    │  │
│  │                   │ │  $ ollama run ... │  │
│  │  Module 3:        │ │  $ python agent.py│  │
